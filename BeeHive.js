...
//======================================
    ...
    function setUpHintDiv() {
        ...
        <br><table id="header"><tr>
            ...
            <font color="black">&nbsp&nbsp# = <b>FOUND words</b></td>
            </tr></table>
...
//======================================
    ...
    async function InitializeHints () {
        ...
        temp = paragraphs[2].textContent.split(/[^0-9]+/);
            ...
            if (temp[4] > '0') El.MetaStats4.innerHTML = '<br><br>(' + temp[4] + ' perfect)';
    ...
    function ToggleChar3 () {
        ...
        if (ShowChar3) {
            ...
            if (ShowRemaining) {
                ...
                <font color="black">&nbsp # = <strong><b>REMAINING words</b></strong>`;
            } else {
                El.Legend.innerHTML = `Σ = <font color="mediumvioletred"><b><strong>TOTAL</strong> words</b>;
                <font color="black">&nbsp # = <b>FOUND words</b>`;
            }
            DisplayTable();
        }
        return;
